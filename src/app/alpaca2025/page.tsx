...
//  const maxNums = Math.pow(4, 4) / 4;
  ...
  function moduleAlpacaActions(action: keyboardModuleEvents) {
  ...
  const handleKeyDown = (event: KeyboardEvent) => {
    ...
    if(action) moduleAlpacaActions(action)
  };
  ...
  return <div className={styles.Alpaca}>
